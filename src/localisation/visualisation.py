...
def draw_bounding_boxes(target, bounding_boxes, color):
    ...
    for bb in bounding_boxes:
        if isinstance(bb, PlaqueMask):
            cv2.rectangle(res, (bb.bb.x, bb.bb.y), (bb.bb.x + bb.bb.w, bb.bb.y + bb.bb.h), color, 2)
        else:
...
def draw_masks(target, masks, color, kernel_size=5):
    ...
    for mask in masks:
        ...
        temp[mask.bb.y:mask.bb.y+mask.bb.h, mask.bb.x:mask.bb.x+mask.bb.w] = mask.mask.astype(np.uint8)
